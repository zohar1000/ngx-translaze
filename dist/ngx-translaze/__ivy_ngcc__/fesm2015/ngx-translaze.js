...
BaseTranslazeService.ɵfac = function BaseTranslazeService_Factory(t) { return new (t || BaseTranslazeService)(ɵngcc0.ɵɵinject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵinject(undefined)); };
BaseTranslazeService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: BaseTranslazeService, factory: BaseTranslazeService.ɵfac });
BaseTranslazeService.ctorParameters = () => [
    { type: ComponentFactoryResolver },
    { type: undefined }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BaseTranslazeService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc0.ComponentFactoryResolver }, { type: undefined }]; }, null); })();
...
TranslazeService.ɵfac = function TranslazeService_Factory(t) { return new (t || TranslazeService)(ɵngcc0.ɵɵinject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵinject(TRANSLAZE_CONFIG)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TranslazeService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: ɵngcc0.ComponentFactoryResolver }, { type: undefined, decorators: [{
                type: Inject,
                args: [TRANSLAZE_CONFIG]
            }] }]; }, null); })();
...
TranslazePipe.ɵfac = function TranslazePipe_Factory(t) { return new (t || TranslazePipe)(ɵngcc0.ɵɵdirectiveInject(TranslazeService)); };
TranslazePipe.ɵpipe = ɵngcc0.ɵɵdefinePipe({ name: "translaze", type: TranslazePipe, pure: true });
TranslazePipe.ctorParameters = () => [
    { type: TranslazeService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TranslazePipe, [{
        type: Pipe,
        args: [{ name: 'translaze' }]
    }], function () { return [{ type: TranslazeService }]; }, null); })();
...
TranslazeFeatureService.ɵfac = function TranslazeFeatureService_Factory(t) { return new (t || TranslazeFeatureService)(ɵngcc0.ɵɵinject(ɵngcc0.ComponentFactoryResolver), ɵngcc0.ɵɵinject(TRANSLAZE_FEATURE_CONFIG), ɵngcc0.ɵɵinject(TranslazeService)); };
TranslazeFeatureService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: TranslazeFeatureService, factory: TranslazeFeatureService.ɵfac });
TranslazeFeatureService.ctorParameters = () => [
    { type: ComponentFactoryResolver },
    { type: undefined, decorators: [{ type: Inject, args: [TRANSLAZE_FEATURE_CONFIG,] }] },
    { type: TranslazeService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TranslazeFeatureService, [{
        type: Injectable
    }], function () { return [{ type: ɵngcc0.ComponentFactoryResolver }, { type: undefined, decorators: [{
                type: Inject,
                args: [TRANSLAZE_FEATURE_CONFIG]
            }] }, { type: TranslazeService }]; }, null); })();
...
TranslazeRootModule.ɵfac = function TranslazeRootModule_Factory(t) { return new (t || TranslazeRootModule)(); };
TranslazeRootModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: TranslazeRootModule });
TranslazeRootModule.ɵinj = ɵngcc0.ɵɵdefineInjector({});
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TranslazeRootModule, [{
        type: NgModule,
        args: [{}]
    }], null, null); })();
...
TranslazeFeatureModule.ɵfac = function TranslazeFeatureModule_Factory(t) { return new (t || TranslazeFeatureModule)(); };
TranslazeFeatureModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: TranslazeFeatureModule });
TranslazeFeatureModule.ɵinj = ɵngcc0.ɵɵdefineInjector({});
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(TranslazeFeatureModule, { declarations: [TranslazePipe], exports: [TranslazePipe] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TranslazeFeatureModule, [{
        type: NgModule,
        args: [{
